...
* });
*
* var out = gfillGreaterThanEqual( [ x, searchElement, alpha, start, end ] );
* // returns <ndarray>[ 5.0, 5.0, 3.0, 0.0, 4.0, -6.0 ]
*/
declare function gfillGreaterThanEqual<T extends typedndarray<unknown> = typedndarray<unknown>>( arrays: [ T, typedndarray<unknown>, typedndarray<unknown>, typedndarray<number>, typedndarray<number> ] ): T;


// EXPORTS //

export = gfillGreaterThanEqual;
